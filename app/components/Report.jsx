    ...
    <div>
      <div>
        <div className="p-3 mt-2">
          Detailed report of {data.first_name.slice(-1)}
        </div>
        <div className="flex w-[800px] justify-center">
          {data.first_name.slice(-1) && (
            <Card key={data._id} className="flex w-[1000px] my-5 " shadow="sm">
              ...
              <Divider />
              <div className="flex justify-end text-slate-400 p-4 h-[30px]">
                <a href={`/edit?id=${data._id}`}>
                  {" "}
                  <FontAwesomeIcon
                    icon={faPenToSquare}
                    size="sm"
                    className="mr-2 flex hover:text-slate-500 hover:cursor-pointer w-[20px]"
                  />
                </a>
              </div>
